...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_create_ingredient_successful(self):
        """Test creation of ingredient is successful"""
        payload = {'name': 'Test'}
    ...
    def test_create_ingredient_failure(self):
        """Test invalid creation does not occur"""
        payload = {'name': ''}
    ...
    def test_retrieve_ingredients_assigned_to_recipe(self):
        ...
        ingredient2 = Ingredient.objects.create(user=self.user, name='Ham')
    ...
    def test_retrieve_ingredients_unique(self):
        """Test filtering returns unique ingredients"""
